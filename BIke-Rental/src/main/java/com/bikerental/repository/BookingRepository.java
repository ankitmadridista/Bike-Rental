...
public interface BookingRepository extends JpaRepository<Booking, Long> {
	...
	//payment gateway
	@Query("Select u from booking u where u.bookBillAmount > ?1 and u.bookPaymentStatus = ?2 and u.custId = ?3")
	public Booking findCustBookToPay(double x, String b, long custId);
